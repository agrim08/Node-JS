...
//*This code will first call start(), then call foo() in "process.nextTick queue".
//*After that, it will handle "promises microtask queue", which prints bar and adds zoo() in "process.nextTick queue" at the same time.
